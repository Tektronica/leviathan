...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.bitmap_button_1 = wx.BitmapButton(self.panel_2, wx.ID_ANY, wx.Bitmap("btn_add_depressed.png", wx.BITMAP_TYPE_ANY))
    ...
    def __do_layout(self):
        ...
        bitmap_1 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("Fluke Logo.png", wx.BITMAP_TYPE_ANY))
